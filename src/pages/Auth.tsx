    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-2xl text-farm-primary font-bold">FarmGest</CardTitle>
          <CardDescription>Sistema de Gestão Pecuária</CardDescription>
        </CardHeader>
        <CardContent>
